...
# Default-Stop:      0 1 6
# Short-Description: Start/stop script for whereami node.js script
### END INIT INFO

# Author: Zach Seifts <zach.seifts+whereami@gmail.com
#
# ______________________________________________________________________________ 
#
...
DAEMON_ARGS="/home/nodejs/apps/whereami/index.js"
DESC="node.js http server"
NODEUSER=nodejs:nodejs
